...
```bash
# view cts report
gvim ~/OpenROAD-flow-scripts/flow/reports/sky130hd/vsdbabysoc/base/4_cts_final.rpt
```

<details>
  <Summary><strong> Final CTS Report</strong></summary>
...
read_db /home/sdudigani/OpenROAD-flow-scripts/flow/results/sky130hd/vsdbabysoc/base/5_2_route.odb
# Write out the DEF file
write_def /home/sdudigani/OpenROAD-flow-scripts/flow/results/sky130hd/vsdbabysoc/base/5_2_route.def
```
...
```bash
# view `route.def`
gvim /home/sdudigani/OpenROAD-flow-scripts/flow/results/sky130hd/vsdbabysoc/base/5_2_route.def
```
...
- The SPEF file captures parasitic RC effects from the physical layout, while the updated Verilog reflects the final net connections post-placement and routing.

### Step 1: Launch OpenROAD
- Set up the environment and navigate to the flow directory, start OpenROAD:
...
- Run the following commands in sequence to load the required design and technology data for VSDBabySoC in OpenROAD shell:

```bash
# these files describe the physical dimensions and metal/via layers for standard cells and macros
read_lef /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/lef/sky130hd.lef
read_lef /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/lef/avsdpll.lef
read_lef /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/lef/avsddac.lef

# This file contains timing and power data for the standard cells
read_liberty /home/sdudigani/OpenROAD-flow-scripts/flow/platforms/sky130hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib

# DEF file represents the post-route physical layout of the design
read_def /home/sdudigani/OpenROAD-flow-scripts/flow/results/sky130hd/vsdbabysoc/base/5_2_route.def
```
...
After loading the `.lef`, `.lib`, and `.def` files, run the following commands to define the process corner and extract parasitics using the available `.calibre` -format model:

#### 1. Define Process Corner

```bash
# Set the process corner using the available Calibre-based extraction rules file
define_process_corner -ext_model_index 0 /home/sdudigani/OpenROAD-flow-scripts/external-resources/open_pdks/sky130/openlane/rules.openrcx.sky130A.nom.calibre
```
...
extract_parasitics -ext_model_file /home/sdudigani/OpenROAD-flow-scripts/external-resources/open_pdks/sky130/openlane/rules.openrcx.sky130A.nom.calibre
```
...
write_spef /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/vsdbabysoc.spef
```
...
write_verilog /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/vsdbabysoc_post_place.v
```
...
```bash
# view generated spef
gvim /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/vsdbabysoc.spef

# view generated post-placement Verilog netlist
gvim /home/sdudigani/OpenROAD-flow-scripts/flow/designs/sky130hd/vsdbabysoc/vsdbabysoc_post_place.v
```
