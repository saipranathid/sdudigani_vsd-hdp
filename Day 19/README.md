...
<a id="tritonroute"></a>
## TritonRoute
- TritonRoute performs detailed routing by utilizing pre-generated global routing guides and applying a **MILP-based (Mixed Integer Linear Programing) panel routing** strategy.
...
### Features
TritonRoute uses pre-processed route guides generated by the global router. These guides serve as high-level blueprints for the detailed routing stage. By following these predefined paths, TritonRoute enhances routing efficiency and quality. The preprocessing involves:
